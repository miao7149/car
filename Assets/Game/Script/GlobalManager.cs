...
public class GlobalManager : MonoBehaviour {
    ...
    //玩家金币
    [HideInInspector] public int PlayerCoin;
    ...
    //当前困难关卡
    [HideInInspector] public int CurrentHardLevel;

    //当前奖杯完成关卡
    [HideInInspector] public int TrophyCompleteLevel;
    ...
    //多语言字典
    [HideInInspector] public Dictionary<string, Dictionary<Language, string>> mLanguageDict = new Dictionary<string, Dictionary<Language, string>>();

    //汽车外观字典
    [HideInInspector] public Dictionary<int, SkinItemData> mTrucksAppearanceDict = new Dictionary<int, SkinItemData>();

    //地形贴图字典
    [HideInInspector] public Dictionary<int, SkinItemData> TerrainMappingDict = new Dictionary<int, SkinItemData>();

    //汽车拖尾字典
    [HideInInspector] public Dictionary<int, SkinItemData> mTrucksTrailDict = new Dictionary<int, SkinItemData>();

    //是否第一次游戏
    [HideInInspector] public bool IsFirstGame = true;

    //行人游戏介绍是否显示过
    [HideInInspector] public bool IsPeoIntroduce = true;

    //信号灯游戏介绍是否显示过
    [HideInInspector] public bool IsLightIntroduce = true;

    //推土机游戏介绍是否显示过
    [HideInInspector] public bool IsBulldozerIntroduce = true;

    //游戏类型
    [HideInInspector] public GameType GameType = GameType.Main;

    //玩家车辆皮肤名称
    [HideInInspector] public string PlayerCarSkinName;

    //玩家车辆拖尾名称
    [HideInInspector] public string PlayerCarTrailName;

    //玩家地图皮肤名称
    [HideInInspector] public string PlayerMapSkinName;
    [HideInInspector] public bool difficuteMode = false;
    ...
    //是否已经开始排位赛
    [HideInInspector] public bool mIsStartRankingMatch = false;
